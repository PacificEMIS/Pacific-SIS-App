...
import com.opensis.adapter.TeacherScheduleAdapter;
import com.opensis.model.Model;
import com.opensis.model.ScheduleModel;
    ...
    public void onClick(View v) {
        if (v==lnForward){
            ...
            try {
                ...
                jsonObject.put("academicYear", pref.getAcademyYear().replace(".0",""));
