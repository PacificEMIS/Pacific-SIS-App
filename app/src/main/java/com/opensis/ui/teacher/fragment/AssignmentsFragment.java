        ...
        if (view==tvAssignmentType){
            ...
            if (etTitle.getText().toString().length()>0) {
                ...
                try {
                    ...
                    assignmentTypeOBJ.put("markingPeriodId", 1);
                    assignmentTypeOBJ.put("schoolId", pref.getSchoolID());
                    assignmentTypeOBJ.put("createdBy", "392a89a6-ff74-47c2-ab69-04ae19bcaeb5");
                    assignmentTypeOBJ.put("tenantId", AppData.tenatID);
            ...
            try {
                ...
                assementObj.put("markingPeriodId",0);
                assementObj.put("updatedBy","392a89a6-ff74-47c2-ab69-04ae19bcaeb5");
                assementObj.put("schoolId",pref.getSchoolID());
                assementObj.put("tenantId",AppData.tenatID);
        ...
        lnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    assismentobj.put("tenantId",AppData.tenatID);
