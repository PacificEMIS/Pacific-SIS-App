...
import com.opensissas.ui.teacher.fragment.SchoolGeneralInfoFragment;
import com.opensissas.ui.teacher.fragment.SchoolWashInfoFragment;
                ...
                if (response != null) {
                    ...
                    try {
                        ...
                        if (_failure){
                            ...
                            schoolStateId= Util.getFreshValue(schoolMaster.optString("schoolStateId"),"-");
                    ...
                    try {
                        ...
                        if (_failure){
                            ...
                            try {
                                ...
                                schoolMasetOBJ.put("tenantId",pref.getTenatID());
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
