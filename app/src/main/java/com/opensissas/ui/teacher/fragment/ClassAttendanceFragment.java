...
import com.opensissas.adapter.AttendanceCodeAdapter;
import com.opensissas.adapter.AttendanceStudentAdapter;
...
public class ClassAttendanceFragment extends Fragment implements View.OnClickListener {
    ...
    int academicyear, attendanceCatID,blockID;
    ArrayList<Integer> codeidlist = new ArrayList<>();
                ...
                if (response != null) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < attendanceCodeList.length(); i++) {
                            ...
                            codeidlist.add(attendanceCode1);
                        }
                        ...
                        obj1.put("attendanceDate", currentDate);
                        obj1.put("_academicYear", pref.getAcademicYear());
                        obj1.put("academicYear", pref.getAcademicYear());
                        obj1.put("tenantId", pref.getTenatID());
                    ...
                    try {
                        ...
                        if (studentAttendance.length() > 0) {
                            ...
                            for (int i = 0; i < studentCount; i++) {
                                ...
                                int pos1 = codeidlist.indexOf(attendanceCode);
                                String pos = codeList.get(pos1).getAttendanceShortName();
                ...
                if (response != null) {
                    ...
                    try {
                        ...
                        if (_failure) {
                            ...
                            obj.put("updatedBy", "2199863c-a77b-4e86-bad3-a524424d969b");
    ...
    private void submitAttendance() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            try {
                ...
                fianlobj.put("blockId", blockID);

                fianlobj.put("updatedBy", "2199863c-a77b-4e86-bad3-a524424d969b");
        ...
        try {
            ...
            jsonObject.put("updatedBy", "2199863c-a77b-4e86-bad3-a524424d969b");
